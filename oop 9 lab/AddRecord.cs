...
namespace oop_9_lab
{
    public partial class AddRecord : Form
    {
        ...
        private void addButton_Click(object sender, EventArgs e)
        {
            ...
            sqlCommand = new SqlCommand("EXEC [InsertMon] @Name, @Surname, @TimeN1, @TimeM1, @TimeM2, @TimeA1, @TimeA2, @TimeE1, @TimeE2, @TimeN2", sqlConnection);
            ...
            if (whatDayOfWeek == 2)
            {
                sqlCommand = new SqlCommand("EXEC [InsertTue] @Name, @Surname, @TimeN1, @TimeM1, @TimeM2, @TimeA1, @TimeA2, @TimeE1, @TimeE2, @TimeN2", sqlConnection);
            }
            if (whatDayOfWeek == 3)
            {
                sqlCommand = new SqlCommand("EXEC [InsertWed] @Name, @Surname, @TimeN1, @TimeM1, @TimeM2, @TimeA1, @TimeA2, @TimeE1, @TimeE2, @TimeN2", sqlConnection);
            }
            if (whatDayOfWeek == 4)
            {
                sqlCommand = new SqlCommand("EXEC [InsertThu] @Name, @Surname, @TimeN1, @TimeM1, @TimeM2, @TimeA1, @TimeA2, @TimeE1, @TimeE2, @TimeN2", sqlConnection);
            }
            if (whatDayOfWeek == 5)
            {
                sqlCommand = new SqlCommand("EXEC [InsertFri] @Name, @Surname, @TimeN1, @TimeM1, @TimeM2, @TimeA1, @TimeA2, @TimeE1, @TimeE2, @TimeN2", sqlConnection);
            }
            if (whatDayOfWeek == 6)
            {
                sqlCommand = new SqlCommand("EXEC [InsertSat] @Name, @Surname, @TimeN1, @TimeM1, @TimeM2, @TimeA1, @TimeA2, @TimeE1, @TimeE2, @TimeN2", sqlConnection);
            }
            if (whatDayOfWeek == 7)
            {
                sqlCommand = new SqlCommand("EXEC [InsertSun] @Name, @Surname, @TimeN1, @TimeM1, @TimeM2, @TimeA1, @TimeA2, @TimeE1, @TimeE2, @TimeN2", sqlConnection);
            }
